...
export const NEW_PASSWORD_SUCCESS = 'NEW_PASSWORD_REQUEST';
export const NEW_PASSWORD_FAILED = 'NEW_PASSWORD_REQUEST';
...
export function resetPasswordRequest(password, token) {
    return function (dispatch) {
        ...
        resetPassword(password, token)
            ...
            .catch((e) =>
                dispatch({type: 'NEW_PASSWORD_FAILED', payload: e.message})
            )
    }
}